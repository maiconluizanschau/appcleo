...
export class ChatSecretoPage {
    ...
    recipient: Chatsecret;//destinatario
    ...
    ionViewDidLoad() {
        ...
        this.userService.currentUser
            ...
            .subscribe((currentUser: User) => { 
                ...
                this.pageTitle = this.recipient.title;
                console.log("Nome do match secreto: "+this.recipient.title);
    ...
    */
    ...
    public abrirPerfilMatch(userMatch: Chatsecret): void{
        console.log("Nome: "+userMatch.title);
