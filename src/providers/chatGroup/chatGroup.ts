...
export class ChatGroupService extends BaseService {
  ...
  private setChats(): void {
    this.afAuth.authState
      .subscribe((authUser: firebase.User) => {//OUVINDO AUTERAÃ‡Ã£o DO AUTSTATE
  ...
  getDeepChat(userId1: string, grupoId2: string): FirebaseObjectObservable<Membros> {
    return <FirebaseObjectObservable<Membros>>this.db.object(`/membros/${userId1}/${grupoId2}`)
      .catch(this.handleObservableError);
  }
